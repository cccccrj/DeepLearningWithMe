...
if __name__ == '__main__':
    ...
    model = MyModel(batch_size=512, learning_rate=0.5, epochs=20)
    history_loss_bn = model.train()
    print("history_loss_bn_05=", history_loss_bn)
    model = MyModel(batch_size=512, learning_rate=0.5, epochs=20, use_bn=False)
    history_loss = model.train()
    print("history_loss_05=", history_loss)
